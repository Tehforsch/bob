...
shadowing1Params = {"center": np.array([0.5, 0.5, 0.7]), "factor": 1000, "size": 0.15, "baseDensity": shadowingDensity}
shadowing2Params = {"center": np.array([0.5, 0.5, 0.7]), "factor": 1000, "size": 0.05, "baseDensity": shadowingDensity}
shadowingCenterParams = {"center": np.array([0.5, 0.5, 0.5]), "factor": 1000, "size": 0.125, "baseDensity": shadowingDensity}
